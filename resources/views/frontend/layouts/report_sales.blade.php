                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="{{ url('') . '/' . config('chatify.routes.prefix') }}" aria-expanded="true"><i
                                        class="fa fa-commenting-o" aria-hidden="true"></i><span>Chat</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <div id="btn-sidebar" class="nav-btn pull-left nav-btn-click"
                                style="border-right: 2px solid #44444445 !important; padding-right: 26px !important; margin-top: 3px !important; height: 25px;">
                                <span></span>
                                <span></span>
                                <span></span>
                            </div>
